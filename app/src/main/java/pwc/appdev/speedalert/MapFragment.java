...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    static int p = 0;
    public TextView speed, distance, time, average;
        ...
        dr.child("Users").child(parts[0]).child("Vehicle Data").child("speed").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try{
                    ...
                    System.out.println("On getspeed (MapFragment): "+e);
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {

                System.out.println("OnCancelled getspeed (MapFragment): "+error);
            }
        });
    }
        ...
        dr.child("Users").child(parts[0]).child("Vehicle Data").child("average").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try{
                    ...
                    System.out.println("On getaverage (MapFragment): "+e);
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {

                System.out.println("OnCancelled getaverage (MapFragment): "+error);
        ...
        dr.child("Users").child(parts[0]).child("Vehicle Data").child("distance").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try{
                    ...
                    System.out.println("On getdistance (MapFragment): "+e);
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {

                System.out.println("OnCancelled getdistance (MapFragment): "+error);
        ...
        dr.child("Users").child(parts[0]).child("Vehicle Data").child("time").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try{
                    ...
                    System.out.println("On gettime (MapFragment): "+e);
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError error) {

                System.out.println("OnCancelled gettime (MapFragment): "+error);
...
//            addPolyRMagsaysay();
    ...
    public void addPolyStoU(){

        List<LatLng> stou = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.RED).geodesic(true);
        options.addAll(stou);
        mMap.addPolyline(options);

    }

    public void addPolyCtoU(){

        List<LatLng> ctou = new ArrayList<LatLng>();
    ...
    public void addPolyLtoP(){

        List<LatLng> ltop = new ArrayList<LatLng>();
    ...
    public void addPolyCPtoMC(){

        List<LatLng> cptomca = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.RED).geodesic(true);
        options.addAll(cptomca);
        mMap.addPolyline(options);
    }

    public void addPolyUtoB(){

        List<LatLng> utob = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.BLUE).geodesic(true);
        options.addAll(utob);
        mMap.addPolyline(options);
    }

    public void addPolyUtoGB(){

        List<LatLng> utogb = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.BLUE).geodesic(true);
        options.addAll(utogb);
        mMap.addPolyline(options);
    }

    public void addPolyPtoJPL(){

        List<LatLng> ptojpl = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.BLUE).geodesic(true);
        options.addAll(ptojpl);
        mMap.addPolyline(options);
    }

    public void addPolyMtoMCA(){

        List<LatLng> mtomca = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.BLUE).geodesic(true);
        options.addAll(mtomca);
        mMap.addPolyline(options);
    }

    public void addPolyEtoMA(){

        List<LatLng> etoma = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.BLUE).geodesic(true);
        options.addAll(etoma);
        mMap.addPolyline(options);
    }

    public void addPolyJPLtoB(){

        List<LatLng> jpltob = new ArrayList<LatLng>();
        ...
        options.addAll(jpltob);
        mMap.addPolyline(options);
    }

    public void addPolyCPLtoCA(){

        List<LatLng> cpltoca = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(cpltoca);
        mMap.addPolyline(options);
    }

    public void addPolyJPLaurel(){

        List<LatLng> jplaurel = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(jplaurel);
        mMap.addPolyline(options);
    }

    public void addPolyRCastillo(){

        List<LatLng> rcastillo = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(rcastillo);
        mMap.addPolyline(options);
    }

    public void addPolyDacudao(){

        List<LatLng> dacudao = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(dacudao);
        mMap.addPolyline(options);
    }

    public void addPolyLapuLapu(){

        List<LatLng> lapulapu = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(lapulapu);
        mMap.addPolyline(options);
    }

    public void addPolyStaAna(){

        List<LatLng> staana = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(staana);
        mMap.addPolyline(options);
    }

    public void addPolyRMagsaysay(){

        List<LatLng> rmagsaysay = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(rmagsaysay);
        mMap.addPolyline(options);
    }

    public void addPolySanPedro(){

        List<LatLng> sanped = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(sanped);
        mMap.addPolyline(options);
    }

    public void addPolyRizal(){

        List<LatLng> rizal = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(rizal);
        mMap.addPolyline(options);
    }

    public void addPolyBonifacio(){

        List<LatLng> bonifacio = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(bonifacio);
        mMap.addPolyline(options);
    }

    public void addPolyJPalmaGil(){

        List<LatLng> jpalmagil = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(jpalmagil);
        mMap.addPolyline(options);
    }

    public void addPolyAPtoM(){

        List<LatLng> apichon = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(apichon);
        mMap.addPolyline(options);
    }

    public void addPolyBtoCir(){

        List<LatLng> bacacacir = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(bacacacir);
        mMap.addPolyline(options);
    }

    public void addPolyEJtoR(){

        List<LatLng> ejtor = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(ejtor);
        mMap.addPolyline(options);
    }

    public void addPolyMabini(){

        List<LatLng> mabini = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(mabini);
        mMap.addPolyline(options);
    }

    public void addPolyTionko(){

        List<LatLng> tionko = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(tionko);
        mMap.addPolyline(options);
    }

    public void addPolyRoxas(){

        List<LatLng> roxas = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(roxas);
        mMap.addPolyline(options);
    }

    public void addPolyClaveria(){

        List<LatLng> claveria = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(claveria);
        mMap.addPolyline(options);
    }

    public void addPolyPontoCB(){

        List<LatLng> cbtocsp = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(cbtocsp);
        mMap.addPolyline(options);
    }

    public void addPolyCBangoy(){

        List<LatLng> cbangoy = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(cbangoy);
        mMap.addPolyline(options);
    }

    public void addBMtoO(){

        List<LatLng> bmtoo = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(bmtoo);
        mMap.addPolyline(options);
    }

    public void addPolyJPLtoA(){

        List<LatLng> jpltoa = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(jpltoa);
        mMap.addPolyline(options);
    }

    public void addPolyQtoGB(){

        List<LatLng> qtogb = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(qtogb);
        mMap.addPolyline(options);
    }

    public void addPolyTulipD(){

        List<LatLng> tulip = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.BLUE).geodesic(true);
        options.addAll(tulip);
        mMap.addPolyline(options);
    }

    public void addPolySandawa(){

        List<LatLng> sandawa = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.BLUE).geodesic(true);
        options.addAll(sandawa);
        mMap.addPolyline(options);
    }

    public void addPolyFTorres(){

        List<LatLng> ftorres = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(ftorres);
        mMap.addPolyline(options);
    }

    public void addPolyBacaca(){

        List<LatLng> bacaca = new ArrayList<LatLng>();
        ...
        PolylineOptions options = new PolylineOptions().width(32).color(Color.GREEN).geodesic(true);
        options.addAll(bacaca);
        mMap.addPolyline(options);
    }

    public void addPolyMedSchoolDr(){

        List<LatLng> medical = new ArrayList<LatLng>();
